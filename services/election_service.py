        ...
        return [
            {
                ...
                "description": "Register yourself as a voter to get your Voter ID.",
            },
            {
                "step": 2,
                "title": "Name Verification",
                "description": "Check if your name appears in the voter list.",
            },
            {
                "step": 3,
                "title": "Election Announcement",
                "description": "Election authority announces the dates.",
            },
            {
                "step": 4,
                "title": "Voting Day",
                "description": "Go to the polling booth, verify identity, and cast your vote.",
            },
            {
                "step": 5,
                "title": "Results",
        ...
        return [
            {
                ...
                "answer": "Any citizen aged 18 or above can vote.",
            },
            {
                "question": "What documents are needed?",
                "answer": "Voter ID card or a valid government ID like Aadhar/Passport.",
            },
        ]
    return data
