...
from services.translate_service import election_translator, translate_service
from services.tts_service import audio_guidance_player, text_to_speech_service
