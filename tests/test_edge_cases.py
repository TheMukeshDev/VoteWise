...
class TestEdgeCases:
    ...
    def test_faq_not_found(self, client):
        ...
        with patch("routes.faq.faq_service.get_by_id") as mock_get:
...
class TestSecurityEdgeCases:
    ...
    def test_xss_in_question(self, client):
        """Test FAQ handles XSS in question."""
        # Patch the route-level faq_service instance, not the service module singleton,
        # because routes/faq.py creates its own FAQService() at import time.
        with patch("routes.faq.faq_service.get_by_id") as mock_get:
