...
def create_polling_guidance() -> tuple:
    ...
    return jsonify(
        success_response(message="Polling guidance created successfully", data=guidance)
    ), 201
...
def update_polling_guidance(guidance_id: str) -> tuple:
    ...
    return jsonify(
        success_response(message="Polling guidance updated successfully", data=guidance)
    ), 200
